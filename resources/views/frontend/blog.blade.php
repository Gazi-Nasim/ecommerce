                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                <div class="blog__item__pic">
                                    <img src="{{asset('uploads/'.$bd->photo)}}" alt="">
                                </div>
                                <div class="blog__item__text">
                                    <ul>
                                        <li><i class="fa fa-calendar-o"></i>{{$bd->created_at}}</li>
                                        <li><i class="fa fa-comment-o"></i> 5</li>
                                    </ul>
                                    <h5><a href="#">{{$bd->headline}}6 ways to prepare breakfast for 30</a></h5>
                                    <p>{{$bd->brief}}Sed quia non numquam modi tempora indunt ut labore et dolore magnam aliquam
                                        quaerat </p>
